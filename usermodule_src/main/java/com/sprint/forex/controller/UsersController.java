...
public class UsersController {
	...
	public ResponseEntity<CommonDTO<String>> forgotPassword(@RequestBody ForgotPassDTO r) throws InvalidInputException {
		...
		if (!isOtpVerify)
			throw new InvalidInputException("OTP not valid");
	...
	public ResponseEntity<CommonDTO<String>> resetPassword(@Valid @RequestBody ResetPasswordDTO r)
			throws InvalidInputException {

		return ResponseEntity
				.ok(new CommonDTO<>(usersService.resetPassword(r.getEmail(), r.getOldPassword(), r.getNewPassword()),
						usersService.resetPassword(r.getEmail(), r.getOldPassword(), r.getNewPassword())));
	}
	...
	@PostMapping("/save")
	public ResponseEntity<CommonDTO<UsersDto>> addUsers(@Valid @RequestBody UsersDto usersDto) {
	...
	public ResponseEntity<CommonDTO<String>> removeUsers(@PathVariable("id") int usersId) {
		...
		return new ResponseEntity<>(new CommonDTO<>("User Deleted Successfully", "Users Deleted Successfully"),
				HttpStatus.OK);
